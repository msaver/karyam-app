...
class CategoryListingHorizontalWidget extends StatelessWidget {
  ...
  CategoryListingHorizontalWidget({Key? key, required this.model})
      : super(key: key);
      ...
      itemBuilder: (BuildContext context, int index) {
        return Padding(
          ...
          child: Card(
            ...
            child: InkWell(
              onTap: () {
                model.updateSelectedCategory(model.categories[index]);
              },
              child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      LinearProgressIndicator(
                        value: model.getProgress(model.categories[index]),
                        minHeight: 2,
                        color: Color(model.categories[index].colorCode),
                      )
                    ],
                  ),
                ),
