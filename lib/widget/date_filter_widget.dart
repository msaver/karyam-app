        ...
        showMenu(
            ...
            items: [
              ...
              PopupMenuItem(
                  ...
                  onTap: () {
                    model.applyFilter(ApplyFilter.today);
                  }),
              PopupMenuItem(
                child: const Text("Tomorrow"),
                onTap: () {
                  model.applyFilter(ApplyFilter.tomorrow);
                },
              ),
              PopupMenuItem(
                child: const Text("Over Due"),
                onTap: () {
                  model.applyFilter(ApplyFilter.overdue);
                },
              ),
              PopupMenuItem(
                ...
                onTap: () async {
                  Future.delayed(Duration.zero, () async {
                    DateTime? dateTime = await showDatePicker(
                        ...
                        context: context,
                        initialDate: model.filterDate,
                        firstDate: DateTime(2000),
                        lastDate: DateTime(2100));
                    if (dateTime != null) {
                      model.applyFilter(ApplyFilter.customDate,
                          dateTime: dateTime);
                    }
                  });
                },
